...
const Monster = function (ctx, x, y, gameArea, mapData, map) {
    ...
    var numObstacleDestroyed = 0;
    var numTrapHit = 0;

    const getNumObstacleDestroyed = function () {
        return numObstacleDestroyed;
    }
    const getNumTrapHit = function () {
        return numTrapHit;
    }
    ...
    const playDestroySound = function () {
        sound.destroy.pause();
        sound.destroy.currentTime = 0;
        sound.destroy.play();
    }

    const playTrapSound = function () {
        sound.trap.pause();
        sound.trap.currentTime = 0;
        sound.trap.play();
    }
    ...
    return {
        ...
        getNumObstacleDestroyed: getNumObstacleDestroyed,
        getNumTrapHit: getNumTrapHit,
    };
};
